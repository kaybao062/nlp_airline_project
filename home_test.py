...
def plot_airline_trends(airline: str = None, aspect: AspectEnum = None):
    ...
    return st.markdown(f"Plot {airline} trend chart!!!")
...
def load_agent():
    ...
    # charting tools:
        ...
        #                             name=f"airline_trend_charts",
        #                             description=(
        #                                 'Provide charts when user asks about trends of overall rating of an {airline}. '
        #                                 'Provides charts for the indexes that is most relevant to the aspect the user care about.'
        #                                 'Use 2-3 sentence to explain the charts. '

        #                             )),
        #     FunctionTool.from_defaults(plot_airline_rate,
        #     name=f"airline_rate_charts",
        #     description=(
        #         'Provide data frame and altair chart when user asks about rating of an {airline}. '
        #         'Use 2-3 sentence to explain the charts. '
